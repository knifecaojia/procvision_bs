...
CREATE TABLE `biz_craft` (
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工艺信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `biz_craft` VALUES (1,'JZ2.940.10287GY-TX02','Ls波段上天线工艺','N.1',1,'2020-2','2026-01-15 11:14:45',NULL,'admin',NULL,NULL);
...
CREATE TABLE `biz_process` (
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工序信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `biz_process` VALUES (1,'30','装配',NULL,'装配',NULL,1,'JZ2.940.10287GY-TX02',NULL,'[{\"errorPreventionMark\":\"\",\"materialName\":\"平垫圈\",\"materialNo\":\"130000461\",\"materialQuantity\":4,\"materialUnit\":\"件\"},{\"errorPreventionMark\":\"\",\"materialName\":\"弹垫\",\"materialNo\":\"130003195\",\"materialQuantity\":4,\"materialUnit\":\"件\"},{\"errorPreventionMark\":\"\",\"materialName\":\"接地柱\",\"materialNo\":\"130026322\",\"materialQuantity\":1,\"materialUnit\":\"件\"},{\"errorPreventionMark\":\"\",\"materialName\":\"射频插座\",\"materialNo\":\"140053164\",\"materialQuantity\":1,\"materialUnit\":\"件\"}]','2026-01-15 11:14:45',NULL,'admin',NULL,NULL),(2,'210','装配',NULL,'装配',NULL,1,'JZ2.940.10287GY-TX02',NULL,'[{\"errorPreventionMark\":\"\",\"materialName\":\"防水透气阀\",\"materialNo\":\"130009362\",\"materialQuantity\":1,\"materialUnit\":\"件\"},{\"errorPreventionMark\":\"\",\"materialName\":\"航向铭牌\",\"materialNo\":\"JZ8.807.10323\",\"materialQuantity\":1,\"materialUnit\":\"件\"},{\"errorPreventionMark\":\"\",\"materialName\":\"铭牌\",\"materialNo\":\"JZ8.807.10324\",\"materialQuantity\":1,\"materialUnit\":\"件\"},{\"errorPreventionMark\":\"\",\"materialName\":\"铭牌\",\"materialNo\":\"JZ8.807.10328\",\"materialQuantity\":1,\"materialUnit\":\"件\"},{\"errorPreventionMark\":\"\",\"materialName\":\"室温固化硅橡胶\",\"materialNo\":\"130004665\",\"materialQuantity\":1,\"materialUnit\":\"件\"},{\"errorPreventionMark\":\"\",\"materialName\":\"螺纹紧固剂\",\"materialNo\":\"130014755\",\"materialQuantity\":1,\"materialUnit\":\"件\"}]','2026-01-15 11:14:46',NULL,'admin',NULL,NULL);
...
CREATE TABLE `biz_step` (
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工步信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `biz_step` VALUES (1,'1','1','按表格准备零部件和辅料。',NULL,1,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(2,'2','2','检查连接器状态，确认一致后装配。',NULL,1,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(3,'3','3','按工序简图所示将连接器装配到腔体上(注意连接器的安装方向)，螺钉紧固前在螺纹根部涂适量乐泰243，按对称交叉分步拧紧，在连接器与腔体接触出面涂抹一圈南大704硅胶。溢出的胶液用脱脂棉蘸无水乙醇清理干净。',NULL,1,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(4,'4','4','按照简图所示安装接地柱，螺母螺纹涂乐泰272螺纹紧固剂。注意接地柱各个零部件安装位置。',NULL,1,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(5,'1','1','天线返回后，检查天线外观，若无划伤、磨损等问题则转调试工序对天线进行参数复测。',NULL,2,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(6,'2','2','按照工序简图所示安装防水透气阀，螺纹涂乐泰243螺纹紧固剂。',NULL,2,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(7,'3','3','将铭牌粘接处的标签去除并做好标签转换成铭牌的编号记录。',NULL,2,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(8,'4','4','用二维码扫描器检查铭牌上的二维码，二维码技术要求如简图所示。',NULL,2,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(9,'5','5','用100#砂纸打磨天线腔体铭牌粘接处，打磨以基本去除表面氧化层为准，打磨完毕用无尘布蘸丙酮清洗干净天线腔体及铭牌上的浮灰，按1-2:1比例配置好3gDG-4胶，做好配胶记录，在铭牌粘接面均匀涂覆一层DG-4胶，对正腔体位置粘贴铭牌，注意铭牌粘贴方向。',NULL,2,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(10,'6','6','固化：温度60℃±2℃，时间3小时，时间到后关闭烘箱电源，打开箱门随箱冷却至室温。',NULL,2,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(11,'7','7','在天线铭牌与腔体粘接四周用704硅橡胶均匀涂覆一层，室温放置4小时以上。',NULL,2,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(12,'8','8','按图示方向粘贴航向铭牌，压平，无翘曲。（安装于沉头螺钉位置正中心）',NULL,2,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL),(13,'9','9','在连接器与腔体接触四周，接地柱安装凸台四周均匀涂抹一圈南大704硅胶，室温晾干。',NULL,2,NULL,'2026-01-15 11:14:46',NULL,'admin',NULL,NULL);
...
INSERT INTO `biz_work_order` VALUES (1,'1000019019-01','JZ4.932.09296060GY-TX01','D.2',1,'01','连接器安装','2025-12-09 08:00:00','2025-12-09 11:30:00',NULL,'0876','王五','100002345','100002345-01','K8989',' 9000000929401','连接器',NULL,NULL,NULL,NULL,NULL),(2,'1000019019-02','JZ4.932.09296060GY-TX01','D.2',1,'02','铭牌安装','2025-12-09 08:00:00','2025-12-09 11:30:00',NULL,'0877','张三','100002345','100002345-01','K8989',' 9000000929415','方向铭牌',NULL,NULL,NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=350 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-15 12:34:42
