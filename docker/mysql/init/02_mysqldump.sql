...
CREATE TABLE `biz_craft` (
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工艺信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `biz_craft` VALUES (1,'JZ2.940.10287GY-TX02','Ls波段上天线工艺','N.1','2020-2',NULL,NULL,NULL,NULL,NULL),(4,'test','test','1.0','111',NULL,NULL,NULL,NULL,NULL),(5,'JD3.850.10398BX-DL05','Ku波段下天线工艺','V.2','2024-1','2025-12-30 10:37:38',NULL,'admin',NULL,NULL);
...
CREATE TABLE `biz_process` (
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工序信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `biz_process_record` VALUES (1,'1000023452-01','1','1','1','Mamba.jpg',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'1000023452-01','2','1','2','Mamba.jpg',NULL,'2025-12-29 17:09:25',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `biz_step` (
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工步信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `biz_step` VALUES (1,'1','1','按表格准备零部件和辅料。',NULL,1,NULL,NULL,NULL,NULL,NULL),(2,'2','2','检查连接器状态，确认一致后装配。',NULL,1,NULL,NULL,NULL,NULL,NULL),(3,'3','3','按工序简图所示将连接器装配到腔体上(注意连接器的安装方向)，螺钉紧固前在螺纹根部涂适量乐泰243，按对称交叉分步拧紧，在连接器与腔体接触出面涂抹一圈南大704硅胶。溢出的胶液用脱脂棉蘸无水乙醇清理干净。',NULL,1,NULL,NULL,NULL,NULL,NULL),(4,'4','4','按照简图所示安装接地柱，螺母螺纹涂乐泰272螺纹紧固剂。注意接地柱各个零部件安装位置。',NULL,1,NULL,NULL,NULL,NULL,NULL),(5,'1','1','天线返回后，检查天线外观，若无划伤、磨损等问题则转调试工序对天线进行参数复测。',NULL,2,NULL,NULL,NULL,NULL,NULL),(6,'2','2','按照工序简图所示安装防水透气阀，螺纹涂乐泰243螺纹紧固剂。',NULL,2,NULL,NULL,NULL,NULL,NULL),(7,'3','3','将铭牌粘接处的标签去除并做好标签转换成铭牌的编号记录。',NULL,2,NULL,NULL,NULL,NULL,NULL),(8,'4','4','用二维码扫描器检查铭牌上的二维码，二维码技术要求如简图所示。',NULL,2,NULL,NULL,NULL,NULL,NULL),(9,'5','5','用100#砂纸打磨天线腔体铭牌粘接处，打磨以基本去除表面氧化层为准，打磨完毕用无尘布蘸丙酮清洗干净天线腔体及铭牌上的浮灰，按1-2:1比例配置好3gDG-4胶，做好配胶记录，在铭牌粘接面均匀涂覆一层DG-4胶，对正腔体位置粘贴铭牌，注意铭牌粘贴方向。',NULL,2,NULL,NULL,NULL,NULL,NULL),(10,'6','6','固化：温度60℃±2℃，时间3小时，时间到后关闭烘箱电源，打开箱门随箱冷却至室温。',NULL,2,NULL,NULL,NULL,NULL,NULL),(11,'7','7','在天线铭牌与腔体粘接四周用704硅橡胶均匀涂覆一层，室温放置4小时以上。',NULL,2,NULL,NULL,NULL,NULL,NULL),(12,'8','8','按图示方向粘贴航向铭牌，压平，无翘曲。（安装于沉头螺钉位置正中心）',NULL,2,NULL,NULL,NULL,NULL,NULL),(13,'9','9','在连接器与腔体接触四周，接地柱安装凸台四周均匀涂抹一圈南大704硅胶，室温晾干。',NULL,2,NULL,NULL,NULL,NULL,NULL),(34,'1','test','1',NULL,5,NULL,NULL,NULL,NULL,NULL),(35,'1','1','按BOM清单核对射频模块、焊锡丝、助焊剂等物料规格及数量，确认无误后方可使用。',NULL,6,'2025-12-30 10:37:38',NULL,'admin',NULL,NULL),(36,'2','2','将焊接台温度调节至380℃±10℃，待温度稳定后，用酒精棉擦拭烙铁头去除氧化层。',NULL,6,'2025-12-30 10:37:38',NULL,'admin',NULL,NULL),(37,'3','3','将射频线缆剥线后，蘸取少量助焊剂，将线芯与射频模块引脚对齐，用烙铁进行点焊，焊接时间控制在2-3秒，避免虚焊、连锡现象。',NULL,6,'2025-12-30 10:37:38',NULL,'admin',NULL,NULL),(38,'4','4','焊接完成后，用放大镜检查焊接点质量，确认无缺陷后，用无尘布蘸异丙醇清理焊接处残留的助焊剂。',NULL,6,'2025-12-30 10:37:38',NULL,'admin',NULL,NULL),(39,'5','5','对焊接后的组件进行通断测试，测试通过后贴上合格标识。',NULL,6,'2025-12-30 10:37:38',NULL,'admin',NULL,NULL),(40,'1','1','将天线组件连接到网络分析仪，设置测试频段为Ku波段，测试驻波比、插入损耗等参数，记录测试数据。',NULL,7,'2025-12-30 10:37:39',NULL,'admin',NULL,NULL),(41,'2','2','若测试参数超出标准范围，需返回上工序进行返修；参数合格则进行下一步操作。',NULL,7,'2025-12-30 10:37:39',NULL,'admin',NULL,NULL),(42,'3','3','用防静电包装袋包裹天线组件，在包装袋表面粘贴产品型号、批次、测试合格标识。',NULL,7,'2025-12-30 10:37:39',NULL,'admin',NULL,NULL),(43,'4','4','将包装好的天线组件放入防震泡沫盒中，盖上盒盖并贴上封条，完成封装。',NULL,7,'2025-12-30 10:37:39',NULL,'admin',NULL,NULL),(44,'5','5','将封装后的产品转运至成品仓库，办理入库手续。',NULL,7,'2025-12-30 10:37:39',NULL,'admin',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=192 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-30 16:15:18
