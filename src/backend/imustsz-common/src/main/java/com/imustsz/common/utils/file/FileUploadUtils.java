package com.imustsz.common.utils.file;
...
import com.imustsz.common.exception.file.FileNameLengthLimitExceededException;
import com.imustsz.common.exception.file.FileSizeLimitExceededException;
import com.imustsz.common.exception.file.InvalidExtensionException;
import com.imustsz.common.utils.DateUtils;
import com.imustsz.common.utils.StringUtils;
import com.imustsz.common.utils.uuid.IdUtils;
import com.imustsz.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = ImustSzConfig.getProfile();
    ...
    {
        int dirLastIndex = ImustSzConfig.getProfile().length() + 1;
