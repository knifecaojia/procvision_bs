        ...
        <el-row class="detail-row">
          <el-col :span="12">
            <div class="detail-item">
              ...
              <el-tag v-if="form.auditStatus === '0'" type="warning" size="small">待审核</el-tag>
              <el-tag v-else-if="form.auditStatus === '1'" type="success" size="small">已通过</el-tag>
              <el-tag v-else-if="form.auditStatus === '2'" type="danger" size="small">已拒绝</el-tag>
            </div>
          </el-col>
          <el-col :span="12">
            <div class="detail-item"><span class="detail-label">审核人</span><span class="detail-value">{{ form.auditBy || '-' }}</span></div>
          </el-col>
        </el-row>
        <el-row class="detail-row">
          <el-col :span="12">
            <div class="detail-item"><span class="detail-label">审核时间</span><span class="detail-value">{{ form.auditTime || '-' }}</span></div>
          </el-col>
          <el-col :span="12">
            <div class="detail-item"><span class="detail-label">审核意见</span><span class="detail-value">{{ form.auditMsg || '无' }}</span></div>
          </el-col>
        </el-row>
      </div>
